class OrdersController < ApplicationController
  ...
  def destroy
    @order.destroy
    respond_to do |format|
      format.html { redirect_to customer_orders_path(@order.customer), notice: 'Order was successfully destroyed.' }
  ...
  private
    ...
    def order_params
      params.require(:order).permit(:cost, :number, :customer_id)
    end
end
